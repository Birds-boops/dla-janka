...
if setup == false {
	...
	for (var p = 0; p < page_number; p++){
		...
		text_x_offset[p] = 546;
		portrait_x_offset[p] = 256;
		//character on the right
		if speaker_side[p] == -1 {
		text_x_offset = 256
		portrait_x_offset[p] = 1438
		}
		//center textbox
		...
		//setting individual characters and finding where the text should break;
...
if draw_char == text_length[page] && page == page_number - 1 {
	...
	for (var op = 0; op < option_number; op++){
		...
		draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x + 128, _txtb_y - _op_space*option_number + _op_space*op, _o_w/txtb_spr_w, ((_op_space - 10)/txtb_spr_h), 0, c_white, 1);
		
		//the arrow
		if option_pos == op {
			draw_sprite(spr_txt_arrow, 0, _txtb_x, _txtb_y - _op_space*option_number + _op_space*op);
		}
		
		//draw option text
		draw_text(_txtb_x + 32 + _op_bord,  _txtb_y - _op_space*option_number + _op_space*op + 5, option[op]);
